...
#Region "Database"
    ...
    Sub CheckPets()
        For i = 1 To MAX_PETS
            If Not File.Exists(System.IO.Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly.Location) & "\Data\pets\pet" & i & ".dat") Then
                SavePet(i)
            End If
        Next
    End Sub
...
#Region "Pet Functions"
    ...
    Function FindPetPath(mapNum As Integer, index As Integer, targetX As Integer, targetY As Integer) As Integer
        ...
        Dim path() As System.Drawing.Point, lastX As Integer, lastY As Integer, did As Boolean
